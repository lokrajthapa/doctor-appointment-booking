<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @endif
                  <form class="max-w-sm mx-auto" action="{{ route('users.update',$user->id) }}" Method="POST"  enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-5">
                        ...
                        <div
                        class="mb-5" >
                        <button type="submit" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Update Profile</button>
                    </div>
